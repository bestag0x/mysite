...
/*
        ...
        <mesh name="mlml" scale={[0.1,0.1,0.1]} geometry={nodes.Object_2.geometry} material={materials.M_Headphone} {...extras} />
*/
console.log(nodes)
  return (
    <group ref={group} {...props} dispose={null}>
      <group
        ...
        <mesh name="Notebook" scale={[3,3,3]} geometry={nodes.pc.geometry} material={materials.M_Notebook} {...extras} />
        <mesh name="Rocket003" geometry={nodes.Rocket003.geometry} material={materials.M_Rocket} {...extras} />
        <mesh name="Zeppelin" geometry={nodes.Zeppelin.geometry} material={materials.M_Zeppelin} v />
        <mesh name="Blade" scale={[3,3,3]} geometry={nodes.blade.geometry} material={materials.blade} v />
        <mesh name="Ig" scale={[3,3,3]} geometry={nodes.ig.geometry} material={materials.ig} v />
        <mesh name="phone" scale={[3,3,3]} geometry={nodes.phone.geometry} material={materials.phone} v />
        <mesh name="Cart" scale={[3,3,3]} geometry={nodes.cart.geometry} material={materials.cart} v />
        <mesh name="text" scale={[3,3,3]} geometry={nodes.Text.geometry} material={materials.text} v />
